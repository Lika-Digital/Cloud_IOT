    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          <div>
            <h3 className="text-gray-100 font-bold text-lg">Configure Sectors — {berth.name}</h3>
            <p className="text-gray-400 text-sm">Draw a detection zone on the camera frame</p>
          </div>
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-gray-700 text-gray-100 text-sm flex items-center justify-center hover:bg-gray-600"
          >
            ✕
          </button>
        </div>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          >
            ...
            <div>
              ...
              <div className="text-gray-100 font-semibold">{berth.name}</div>
