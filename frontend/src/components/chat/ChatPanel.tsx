...
export default function ChatPanel({ customerId, customerName, onClose }: ChatPanelProps) {
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-gray-900 border border-gray-700 rounded-xl w-full max-w-lg shadow-2xl flex flex-col" style={{ height: 520 }}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <h3 className="text-white font-bold">Chat — {customerName ?? `Customer #${customerId}`}</h3>
